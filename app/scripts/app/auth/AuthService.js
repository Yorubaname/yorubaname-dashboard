...
angular.module("dashboardappApp")
    .service('authService', ['baseService', 'usersService', '$localStorage', '$state', '$rootScope', '$timeout',
        'toastr', 'ENV', function(api, usersApi, $localStorage, $state, $rootScope, $timeout, toastr, ENV){
    ...
    this.authenticate = function(authData) {
        ...
        var token = btoa(authData.email + ":" + authData.password);
