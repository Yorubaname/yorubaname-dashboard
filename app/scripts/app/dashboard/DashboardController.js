  ...
  function ($scope, api) {
    ...
    api.countNames('', function (resp) {
      ...
      $('.countUpMe .all_names').each(function () {
        var target = this, endVal = $scope.count_all_names, theAnimation = new countUp(target, 0, endVal, 0, 2.6, {
            useEasing: true,
            useGrouping: true,
            separator: ' '
          });
      ...
      $('.countUpMe .published_names').each(function () {
        var target = this, endVal = $scope.count_published_names, theAnimation = new countUp(target, 0, endVal, 0, 2.6, {
            useEasing: true,
            useGrouping: true,
            separator: ' '
          });
      ...
      $('.countUpMe .unpublished_names').each(function () {
        var target = this, endVal = $scope.count_unpublished_names, theAnimation = new countUp(target, 0, endVal, 0, 2.6, {
            useEasing: true,
            useGrouping: true,
            separator: ' '
          });
      ...
      $('.countUpMe .modified_names').each(function () {
        var target = this, endVal = $scope.count_modified_names, theAnimation = new countUp(target, 0, endVal, 0, 2.6, {
            useEasing: true,
            useGrouping: true,
            separator: ' '
          });
