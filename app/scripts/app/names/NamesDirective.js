...
dashboardappApp
    ...
    .directive('namesUpload', ['uploadService', function(Uploader) {
        return {
    ...
    .directive('feedback', ['namesService', '$modal', '$stateParams', '$rootScope',  function(api, $modal, $stateParams, $rootScope){
        return {
            //replace: true,
            restrict: 'EA',
